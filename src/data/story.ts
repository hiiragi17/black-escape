...
export const storyData: StoryDataType = {
  ...
  "company_divide_strategy": {
    "text": "休憩時間、人事部長が後輩を別室に呼び出した。\n\n30分後、後輩が戻ってきた。\n\n後輩「実は...個別に和解金を出すから抜けてくれって言われました」\n\n「それ、組合を分断する作戦だぞ！」\n\nどう対応する？",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/d6.mp3",
    "choices": [
  ...
  "recording_evidence_timing": {
    "text": "交渉は膠着状態に。会社は一部支払いでお茶を濁そうと提案してきた。\n\n「それでは不十分です」\n\n会社側弁護士「これ以上は無理だ。裁判になってもいいのか？」\n\n「分かりました...では、これを聞いてください」\n\n録音を流す。人事部長の「クビにしてやる！」という音声が響く。\n\n会社側、完全に青ざめた。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "この機会に冷静に全額支払いを要求", "next": "negotiation_final_stage" },
      { "text": "勢いに任せて慰謝料まで一気に上乗せ要求", "next": "lawyer_negotiation_breakdown" }
    ]
  },

  "negotiation_final_stage": {
    "text": "録音証拠の威力は絶大だった。\n\n会社側弁護士「...分かりました。一部の支払いで和解しませんか？」\n\n弁護士「いえ、未払い分の満額の支払いを求めます」\n\n会社側「それは...」\n\nここが正念場だ。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "満額の支払いまで粘る", "next": "win_overtime_pay" },
      { "text": "妥協して一部の支払いで合意", "next": "weak_union_settlement" },
      { "text": "さらに慰謝料も請求する", "next": "lawyer_negotiation_breakdown" }
    ]
  },

  "win_overtime_pay": {
    "text": "ついに残業代全額の支払いを勝ち取った！\n\n「月給が5万円も上がった...」\n「組合作って本当に良かった」\n\n同期「他の部署の人たちも羨ましがってるよ。組合に入りたいって10人以上から連絡来てる」\n\n「これは...組合を全社に広げるチャンスかも」\n\nでも、慎重に進めないと管理職の反発が...。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
  ...
  "union_expansion_planning": {
    ...
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "管理職の動きを警戒し、慎重に足場を固める", "next": "management_resistance" },
      { "text": "勢いそのままに一気に全社へ呼びかける", "next": "premature_expansion" }
    ]
  },
  ...
  "research_lawyers": {
    "text": "労働問題専門の弁護士事務所を慎重にリサーチした。\n\nネットで口コミサイト、実績、料金体系を片っ端からチェック。労働審判の経験、残業代請求の成功率、相談者の評価...。\n\n「この『みらい法律事務所』、ブラック企業案件の実績が200件以上もある」\n\n着手金は高めだが、専門性があるほうが確実だ。\n\n「失敗したくない。ここに賭けよう」\n\n初回無料相談を予約した。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "実績重視で初回相談に行く", "next": "lawyer_initial_consultation" },
      { "text": "やはり費用が惜しくなり、安い事務所に乗り換える", "next": "incompetent_lawyer" }
    ]
  },
  ...
  "lawyer_strategy_meeting_rushed": {
    ...
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "この条件のまま交渉を開始する", "next": "lawyer_individual_negotiation" },
      { "text": "やはり不安なので、追加で証拠を集め直す", "next": "gather_more_evidence" }
    ]
  },
  ...
  "lawyer_individual_negotiation": {
    "text": "弁護士「会社に内容証明郵便で、未払い残業代全額の請求書を送りました」\n\n数日後、会社から連絡がきた。\n\n会社「証拠不十分です。こんな金額は払えません」\n\nどう対応する？",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
  ...
  "settlement_amount_negotiation": {
    "text": "脅迫を記録したことで、会社側の態度が軟化した。\n\n会社「...では、この金額ではどうでしょうか？」\n\n弁護士「我々はもっと上の金額を提案します」\n\n会社「それは...」\n\nどこまで粘る？",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
      { "text": "弁護士と相談して妥当な金額で合意", "next": "company_counteroffer" },
      { "text": "すぐに会社の提示額で受け入れる", "next": "quick_low_settlement" },
      { "text": "絶対に満額を譲らない", "next": "lawyer_negotiation_breakdown" }
    ]
  },

  "company_counteroffer": {
    "text": "弁護士「この金額で合意しましょう。これ以上は時間がかかるだけです」\n\n会社「...分かりました。和解金に加えて労働環境改善の約束ではどうですか？」\n\n弁護士「十分な条件です。受け入れましょう」\n\n和解契約書が作成された。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
  ...
  "assert_own_demands": {
    "text": "自分の主張を強く出すことにした。\n\n「こんな端金は馬鹿にしてる。法定通りに払え」\n\n会社側が怒った。\n\n弁護士「自分で交渉するのは避けた方が...」\n\n会社の対応が悪くなった。最終的に相場よりかなり低い和解に留まった。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
  ...
  "continue_improved_company": {
    "text": "改善された会社で、しばらく働き続けることにした。\n\n是正勧告や交渉のおかげで、残業代は前より支払われるようになり、定時で帰れる日も増えてきた。\n\nだが、根っこの体質が変わったわけではない。上司の高圧的な態度はふとした時に顔を出すし、有給はまだ取りづらい空気が残っている。\n\n「ここで満足していいのか、それとも――」\n\nまだ、できることはあるのかもしれない。",
    "background": "/images/bg/office.jpg",
    "bgm": "/bgm/n43.mp3",
    "choices": [
  ...
  "incompetent_lawyer": {
    "text": "安い弁護士に依頼した。\n\n弁護士「まあ、やってみますよ」\n\n交渉が始まったが、弁護士の知識が明らかに不足している。\n\n会社側弁護士「労働基準法第何条ですか？」\n弁護士「え、と...」\n\n会社にいいようにあしらわれ、結局すずめの涙ほどの和解金で終了。\n\n安物買いの銭失いだった。\n\n【バッドエンド：無能な弁護士で大損失】",
    "background": "/images/bg/bad_end_office.jpg",
    "bgm": "/bgm/d6.mp3",
    "choices": []
  },
